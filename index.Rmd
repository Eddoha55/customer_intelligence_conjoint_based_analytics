...
- Marque: pas de différence significative entre Audi et BMW, mais par contre la "willingness to pay"" d'un client pour une Mercedes est plus faible de 26577.99 euros (faire apparaitre le calcul coef(m1)["brandMercedes"]/coef(m1)["price"] ) et préciser quece chiffre reflète certainement un biais d'échantillon
- Price: le prix a un impact significatif sur le choix
- Type: pas d'impact que ça soit une berline ou un SUV, par contre une city_car baisse la willingness to pay de 8613.325 euros (coef(m1)["typecity_car"]/coef(m1)["price"])
